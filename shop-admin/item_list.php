		...
		<script type="text/javascript">
			...
			app.controller('promotion_cl',['$scope','$http',function($scope, $http){
				...
				$scope.btnDeletePromotion = function(proId){
					swal({   
						title: "<span style='font-size: 25px;'>You are about to delete promotion.</span>",
				...
				$('#frmAddPromotion').bootstrapValidator({
					...
					fields: {
						itemId: {
	                        validators: {
								notEmpty: {
									message: 'The item ID is required and cannot be empty'
								}
							} 
						},
						itemName: {
									...
									<div class="modal-body">
										<div class="row">
											<form id="frmAddPromotion" method="post">
												<div class="col-sm-6">
													<div class="form-group">
														<label>Item ID <span class="requrie">(Required)</span></label>
														<input  id="itemId" name="itemId" class="form-control" type="text" placeholder="">
													</div>
												</div>
												<div class="col-sm-6">
													<div class="form-group">
														<label>Item Name <span class="requrie">(Required)</span></label>
														<input  id="itemName" name="itemName" class="form-control" type="text" placeholder="">
													</div>
												</div>
												<div class="clearfix"></div>
												<div class="col-sm-6">
													<div class="form-group">
														<label>Category <span class="requrie">(Required)</span></label> 
														<select name="category" class="form-control select2" style="width:100%;" id="category">												
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label>Brand</label> 
														<select name="brand" class="form-control select2" style="width:100%;" id="brand">
															<option value="">SELECT A BRAND</option>
															<?php foreach($brand_data as $b){ ?>
															<option value="<?php echo $b['var_id']; ?>"><?php echo '['.$b['var_id'].'] '.$b['var_name']; ?></option>
															<?php } ?>
														</select>
													</div>
												</div>
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label>Show In POS <span class="requrie">(Required)</span></label> 
														<select name="showInPos" class="form-control" id="showInPos">
